...
class Assignment(db.Model):
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        assertions.assert_valid(assignment.teacher_id == auth_principal.teacher_id, 'This assignment was submitted to an another teacher')
    ...
    def get_assignments_by_teacher(cls, teacher_id):
        return cls.filter(cls.teacher_id == teacher_id).filter((cls.state == AssignmentStateEnum.SUBMITTED)|(cls.state == AssignmentStateEnum.GRADED)).all()
